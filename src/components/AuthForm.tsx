...
import { Mail, Lock, User as UserIcon, Eye, EyeOff, ArrowRight, CheckCircle2, AlertCircle, Sparkles } from 'lucide-react';
...
export const AuthForm: React.FC<AuthFormProps> = ({
  ...
  const { login, register, sendPasswordReset, isLoading: isAuthLoading } = useAuth();
