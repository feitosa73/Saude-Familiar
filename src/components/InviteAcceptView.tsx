        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden p-6 sm:p-8">
          {isLoadingInfo ? (
            ...
            <div className="space-y-5">
              ...
              {!user ? (
                /* Unauthenticated State -> Sign in with Google or Email CTA */
                <div className="space-y-3 pt-2">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-white border-2 border-slate-200 hover:border-slate-400 hover:bg-slate-50 text-slate-800 font-bold py-3 px-4 rounded-xl shadow-xs transition-all text-xs sm:text-sm cursor-pointer"
                  >
                  ...
                  <button
                    type="button"
                    id="btn-invite-email-login"
                    onClick={() => setIsAuthModalOpen(true)}
                    disabled={isAuthLoading}
                    className="w-full flex items-center justify-center gap-2 bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold py-2.5 px-4 rounded-xl transition text-xs sm:text-sm cursor-pointer"
                  >
                    <Mail className="w-4 h-4 text-slate-600" />
                    <span>Entrar ou Criar conta com E-mail</span>
                  </button>

                  <p className="text-[11px] text-slate-400 text-center">
                    Faça login com a conta correspondente ao e-mail convidado ({invitationInfo.invitedEmailMasked}).
                  </p>
                </div>
              ) : (
